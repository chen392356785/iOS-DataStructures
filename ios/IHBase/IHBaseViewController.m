...
//    [[UINavigationBar appearance] setBackgroundImage:[self imageWithColor:RGB(247 , 248, 250) andSize:CGSizeMake(_deviceSize.width, 64)] forBarMetrics:UIBarMetricsDefault];

    titleLabel=[[SMLabel alloc] initWithFrame:CGRectMake(70, 8,_deviceSize.width-140, 30)];
    [titleLabel setFont:sysFont(16)];
...
-(void)setTitle:(NSString *)title andTitleColor:(UIColor *)Color {
    if (title == nil || [title length] == 0) {
        titleLabel.hidden = YES;
    }
    else
...
*/
//-(void)CancleHTTPConneCancleHTTPConnectionNotificationctionNotification:(NSNotification *)notification{
