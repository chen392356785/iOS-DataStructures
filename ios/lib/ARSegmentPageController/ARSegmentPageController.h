...
@interface ARSegmentPageController : SMBaseViewController<ARSegmentViewMenusDelegate>
...
-(instancetype)initWithControllersForTitle:(NSArray *)titleArray  controller:(UIViewController<ARSegmentControllerDelegate> *)controller,... NS_REQUIRES_NIL_TERMINATION;
