...
//    [saveButton setBackgroundImage:Image(@"main_download.png") forState:UIControlStateNormal];
...
//                PHAssetChangeRequest *req = [PHAssetChangeRequest creationRequestForAssetFromImage:nil];
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    UIAsyncImageView *tempView = [[UIAsyncImageView alloc] init];
