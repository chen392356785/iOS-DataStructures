...
- (void)setView{
    ...
    [_reduceBtn setTitleColor:kColor(@"#05C1B0") forState:UIControlStateNormal];
//    [_reduceBtn setImage:[UIImage imageNamed:@"btn_num_minus"] forState:UIControlStateNormal];
    ...
    _reduceBtn.titleLabel.font = [UIFont systemFontOfSize:24];
...
//    [_addBtn setImage:[UIImage imageNamed:@"btn_num_add"] forState:UIControlStateNormal];
    ...
    [_addBtn setTitleColor:kColor(@"#05C1B0") forState:UIControlStateNormal];
    ...
    if (_buttonTextColor) {
        [_reduceBtn setTitleColor:_buttonTextColor forState:UIControlStateNormal];
        [_addBtn setTitleColor:_buttonTextColor forState:UIControlStateNormal];
    }
}
