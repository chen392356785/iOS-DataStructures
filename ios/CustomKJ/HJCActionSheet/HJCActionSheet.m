...
- (instancetype)initWithDelegate:(id<HJCActionSheetDelegate>)delegate CancelTitle:(NSString *)cancelTitle OtherTitles:(NSString *)otherTitles, ...
{
    ...
    sheetViewF.size.height = BtnHeight * _tag + Margin + TFXHomeHeight;
    sheetView.frame = sheetViewF;
    
    // 取消按钮
    UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(0, sheetView.frame.size.height - BtnHeight - TFXHomeHeight, ScreenWidth, BtnHeight)];
...
- (instancetype)initWithDelegate:(id<HJCActionSheetDelegate>)delegate CancelTitle:(NSString *)cancelTitle title:(NSString *)title OtherTitles:(NSString *)otherTitles, ...
{
   ...
   // [btn setBackgroundImage:highImage forState:UIControlStateHighlighted];
    ...
    // 取消按钮
    btn = [[UIButton alloc] initWithFrame:CGRectMake(0, sheetView.frame.size.height - BtnHeight - TFXHomeHeight, ScreenWidth, BtnHeight)];
    [btn setBackgroundImage:normalImage forState:UIControlStateNormal];
    [btn setBackgroundImage:highImage forState:UIControlStateHighlighted];
    [btn setTitle:cancelTitle forState:UIControlStateNormal];
    [btn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
...
-(void)setupBtnImageWithTitle:(NSDictionary *)dic{
    ...
    UIImage *img=Image(dic[@"img"]);
    UIImage *tapimg=Image(dic[@"tapimg"]);
    ...
    [btn setTitleColor:[IHUtility colorWithHexString:@"#666666"] forState:UIControlStateNormal];
