...
- (void)showImage:(UIAsyncImageView *)defaultImageView{
    ...
    [imageView sd_setImageWithURL:[NSURL URLWithString:self.thumbUrl] placeholderImage:[UIImage imageNamed:@"moren2.png"] options:SDWebImageRetryFailed completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
...
//    [imageView sd_setImageWithURL:[NSURL URLWithString:self.thumbUrl] placeholderImage:[UIImage imageNamed:@"moren2.png"] options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize) {
//        imageViewWeak.pro = (CGFloat)receivedSize / expectedSize;
//
...
- (void)hideImage:(UITapGestureRecognizer*)tap{
    ...
    [UIView animateWithDuration:_duration animations:^{
        imageView.frame = self->defaultRect;
