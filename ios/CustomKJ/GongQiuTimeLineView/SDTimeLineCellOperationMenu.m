...
- (void)setup
{
    ...
    self.backgroundColor = SDColor(0, 193,175, 1);
    
    _likeButton = [self creatButtonWithTitle:@"赞" image:[UIImage imageNamed:@"bai_zan"] selImage:[UIImage imageNamed:@""] target:self selector:@selector(likeButtonClicked)];
    _commentButton = [self creatButtonWithTitle:@"评论" image:[UIImage imageNamed:@"bai_pinglun"] selImage:[UIImage imageNamed:@""] target:self selector:@selector(commentButtonClicked)];
