...
-(void)_createView
{
    ...
    _pickView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, navigationViewHeight, kScreenWidth, pickViewViewHeight-20+50)];
...
-(void)showBottomView
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self->_bottomView.top = kScreenHeight-navigationViewHeight-pickViewViewHeight-50;
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"AddressPickViewHidden" object:nil];
    [UIView animateWithDuration:0.3 animations:^{
