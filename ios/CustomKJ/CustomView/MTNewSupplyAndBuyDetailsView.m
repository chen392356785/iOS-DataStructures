...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView *lineView=[[UIView alloc]initWithFrame:CGRectMake(0, 0, WindowWith-10, 1)];
        ...
        lineView=[[UIView alloc]initWithFrame:CGRectMake(0, _headImageView.bottom+10, WindowWith, 1)];
        lineView.backgroundColor=cLineColor;
        [self addSubview:lineView];
        
        MTSupplyAndBuyDetailsImageView *imagesView=[[MTSupplyAndBuyDetailsImageView alloc]initWithFrame:CGRectMake(headImageView.left, lineView.bottom+3, WindowWith-headImageView.left*2, 400)];
        _imagesView=imagesView;
        [self addSubview:imagesView];
        
        
        lbl=[[SMLabel alloc]initWithFrameWith:CGRectMake(headImageView.left, imagesView.bottom+0.08*WindowWith,  WindowWith-headImageView.left*2, 15) textColor:cBlackColor textFont:sysFont(15)];
        lbl.text=@"【供应】中国红樱花";
        _tilteLbl=lbl;
        [self addSubview:lbl];
        
        
        lbl=[[SMLabel alloc]initWithFrameWith:CGRectMake(WindowWith-headImageView.left-80 , lbl.bottom, 60, 18) textColor:cGreenColor textFont:sysFont(18)];
        lbl.text=@"￥ 320";
        _pricelbl=lbl;
        [self addSubview:lbl];
        ...
        lineView=[[UIView alloc]initWithFrame:CGRectMake(0, lbl.bottom+11, WindowWith, 1)];
      ...
      UIImageView  *imageView=[[UIImageView alloc]initWithFrame:CGRectMake(lbl.left, lineView.bottom+5, Img.size.width, Img.size.height)];
        imageView.image=Img;
...
//        }
    ...
    if (model.supply_id) {
        NSString *s=[NSString stringWithFormat:@"【供应】%@",model.varieties];
        ...
        NSString *s=[NSString stringWithFormat:@"【求购】%@",model.varieties];
