...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        bottomContainerView.backgroundColor = [UIColor lightGrayColor];
        bottomContainerView.frame = CGRectMake(0, HKL_ScreenHeight, HKL_ScreenWidth, HKL_ScreenHeight * 0.5);
...
- (void)bottomContainerViewAddSubviews:(UIView *)superView {
    ...
    titleLabel.left = HKL_ScreenWidth * 0.5 - titleLabel.width * 0.5;
...
- (void)showCoverView {
    ...
    [UIView animateWithDuration:self.animationTime animations:^{
        self.bottomContainerView.top = HKL_ScreenHeight * self.screenHeightPercent;
...
- (void)hideCoverView {
    [UIView animateWithDuration:self.animationTime animations:^{
        self.bottomContainerView.top = HKL_ScreenHeight;
    } completion:^(BOOL finished) {
        self.hidden = YES;
