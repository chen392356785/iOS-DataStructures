...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _leftImageView = [[UIAsyncImageView alloc]initWithFrame:CGRectMake(0, 0, kAdViewWidth, kAdViewHeight)];
//        _leftImageView.contentMode = 0;
        [_adScrollView addSubview:_leftImageView];
        
        _centerImageView = [[UIAsyncImageView alloc]initWithFrame:CGRectMake(kAdViewWidth, 0, kAdViewWidth, kAdViewHeight)];
//        _centerImageView.contentMode = 0;
        ...
        _rightImageView = [[UIAsyncImageView alloc]initWithFrame:CGRectMake(kAdViewWidth*2, 0, kAdViewWidth, kAdViewHeight)];
//        _rightImageView.contentMode = 0;
...
+ (id)adScrollViewWithFrame:(CGRect)frame imageLinkURL:(NSArray *)imageLinkURL placeHoderImageName:(NSString *)imageName pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    for (NSDictionary * dic in imageLinkURL)
    {
        NSURL * imageURL = [NSURL URLWithString:dic[@"activities_pic"]];
    ...
    adView.imageLinkURL = [imageLinkURL mutableCopy];
    return adView;
}
...
- (void)setImageLinkURL:(NSArray *)imageLinkURL
{
    ...
    NSDictionary *dic1=[imageLinkURL objectAtIndex:leftImageIndex];
    NSDictionary *dic2=[imageLinkURL objectAtIndex:centerImageIndex];
    NSDictionary *dic3=[imageLinkURL objectAtIndex:rightImageIndex];
    NSString *imgStr1=[dic1 objectForKey:@"activities_pic"];
    NSString *imgStr2=[dic2 objectForKey:@"activities_pic"];
    NSString *imgStr3=[dic3 objectForKey:@"activities_pic"];
    
    if (self.placeHoldImage == nil) {
        self.placeHoldImage = DefaultImage_logo;
    }
    [_leftImageView sd_setImageWithURL:[NSURL URLWithString:imgStr1] placeholderImage:self.placeHoldImage];
    [_centerImageView sd_setImageWithURL:[NSURL URLWithString:imgStr2] placeholderImage:self.placeHoldImage];
    [_rightImageView sd_setImageWithURL:[NSURL URLWithString:imgStr3] placeholderImage:self.placeHoldImage];
...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
    ...
    _centerAdLabel.font = sysFont(15);
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    {
        _pageControl.frame = CGRectMake( kAdViewWidth - 20*_pageControl.numberOfPages, kAdViewHeight - 30, 20*_pageControl.numberOfPages, 20);
    }
    _pageControl.currentPage = 0;
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    NSDictionary *dic1=[_imageLinkURL objectAtIndex:leftImageIndex];
    NSDictionary *dic2=[_imageLinkURL objectAtIndex:centerImageIndex];
    NSDictionary *dic3=[_imageLinkURL objectAtIndex:rightImageIndex];
    NSString *imgStr1=[dic1 objectForKey:@"activities_pic"];
    NSString *imgStr2=[dic2 objectForKey:@"activities_pic"];
    NSString *imgStr3=[dic3 objectForKey:@"activities_pic"];
