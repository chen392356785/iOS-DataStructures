...
/** 默认的列数 */
static const NSInteger TFDefaultColumnCount = 2;
/** 每一列之间的间距 */
static const CGFloat TFDefaultColumnMargin = 5;
/** 每一行之间的间距 */
static const CGFloat TFDefaultRowMargin = 10;
/** 边缘间距 */
static const UIEdgeInsets TFDefaultEdgeInsets = {10, 10, 10, 10};

@interface TFWaterflowLayout ()
