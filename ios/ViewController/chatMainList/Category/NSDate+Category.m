...
- (NSString *)timeIntervalDescription
{
	...
	if (timeInterval < 60) {
        ...
        NSDateFormatter *dateFormatter = [NSDateFormatter dateFormatterWithFormat:NSLocalizedString(@"NSDateCategory.text6", @"")];
        return [dateFormatter stringFromDate:self];
    }
}
...
//    return [[NSDate dateWithTimeIntervalInMilliSecondSince1970:time] formattedTime];
    ...
    NSString *dateString = [dateFormatter stringFromDate:[NSDate dateWithTimeIntervalInMilliSecondSince1970:time]];
    return [IHUtility compareCurrentTimeString:dateString];
}
