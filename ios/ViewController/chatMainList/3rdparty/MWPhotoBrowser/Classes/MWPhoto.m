    ...
    if (_image) {
        ...
        if ([[[_photoURL scheme] lowercaseString] isEqualToString:@"assets-library"]) {
            ...
            @try {
				...
				_webImageOperation = [manager downloadImageWithURL:_photoURL options:0 context:NULL progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
					if (expectedSize > 0) {
