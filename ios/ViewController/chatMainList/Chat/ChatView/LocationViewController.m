...
- (void)viewDidLoad
{
   ...
   // self.title = ;
    [self setTitle:NSLocalizedString(@"location.messageType", @"location message")];
...
//    [self.navigationItem setLeftBarButtonItem:backItem];
    ...
    _mapView = [[MKMapView alloc] initWithFrame:CGRectMake(0, 0, WindowWith, WindowHeight)];
...
- (void)startLocation
{
    ...
    [self showHudInView:_mapView hint:NSLocalizedString(@"location.ongoning", @"locating...")];
}
