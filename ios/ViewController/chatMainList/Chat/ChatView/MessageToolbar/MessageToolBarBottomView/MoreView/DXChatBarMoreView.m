...
- (void)setupSubviewsForType:(ChatMoreType)type
{
    ...
    UILabel *lbl=[[UILabel alloc]initWithFrame:CGRectMake(insets, CGRectGetMaxY(_photoButton.frame), CHAT_BUTTON_SIZE, 21)];
    lbl.textAlignment=NSTextAlignmentCenter;
    lbl.text=@"照片";
    lbl.textColor=[UIColor colorWithRed:111/255.0 green:114/255.0 blue:119/255.0 alpha:1.0];
    lbl.font=sysFont(13);
    [self addSubview:lbl];
    ...
    lbl=[[UILabel alloc]initWithFrame:CGRectMake(insets* 2 + CHAT_BUTTON_SIZE, CGRectGetMaxY(_locationButton.frame), CHAT_BUTTON_SIZE, 21)];
    lbl.textAlignment=NSTextAlignmentCenter;
    lbl.text=@"位置";
    lbl.textColor=[UIColor colorWithRed:111/255.0 green:114/255.0 blue:119/255.0 alpha:1.0];
    lbl.font=sysFont(13);
    ...
    lbl=[[UILabel alloc]initWithFrame:CGRectMake(insets* 3 + CHAT_BUTTON_SIZE * 2, CGRectGetMaxY(_takePicButton.frame), CHAT_BUTTON_SIZE, 21)];
    lbl.textAlignment=NSTextAlignmentCenter;
    lbl.text=@"拍照";
    lbl.textColor=[UIColor colorWithRed:111/255.0 green:114/255.0 blue:119/255.0 alpha:1.0];
    lbl.font=sysFont(13);
    ...
    if (type == ChatMoreTypeChat) {
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake(insets* 4 + CHAT_BUTTON_SIZE * 3-5, CGRectGetMaxY(_audioCallButton.frame), CHAT_BUTTON_SIZE+10, 21)];
        lbl.textAlignment=NSTextAlignmentCenter;
        lbl.text=@"语音聊天";
        lbl.textColor=[UIColor colorWithRed:111/255.0 green:114/255.0 blue:119/255.0 alpha:1.0];
        lbl.font=sysFont(13);
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake(insets-5, CGRectGetMaxY(_videoCallButton.frame), CHAT_BUTTON_SIZE+10, 21)];
        lbl.textAlignment=NSTextAlignmentCenter;
        lbl.text=@"视频聊天";
        lbl.textColor=[UIColor colorWithRed:111/255.0 green:114/255.0 blue:119/255.0 alpha:1.0];
        lbl.font=sysFont(13);
