...
//    self.inputTextView.contentMode = UIViewContentModeCenter;
    ...
    self.recordButton.titleLabel.font = sysFont(15);
    ...
    if (!self.faceView) {
        ...
        self.faceView.backgroundColor = [UIColor colorWithRed:247 / 255.0 green:247 / 255.0 blue:247 / 255.0 alpha:1.0];
        self.faceView.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
    }
    
    if (!self.recordView) {
        self.recordView = [[DXRecordView alloc] initWithFrame:CGRectMake(90, 130, 130, 130)];
    }
