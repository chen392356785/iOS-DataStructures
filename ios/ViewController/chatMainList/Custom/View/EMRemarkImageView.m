...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _imageView = [[UIAsyncImageView alloc] initWithFrame:CGRectMake(hMargin, vMargin, frame.size.width - vMargin, frame.size.height - vMargin)];
...
-(void)setImageURL:(NSString *)url{
    [_imageView setImageAsyncWithURL:url placeholderImage:[UIImage imageNamed:@"chatListCellHead.png"]];
}
@end
