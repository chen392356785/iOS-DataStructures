...
- (void)viewDidLoad {
    ...
    NSDictionary *userDic=[dic objectForKey:_chatter];
    [_headerImageView sd_setImageWithURL:[NSURL URLWithString:userDic[kToHeadImage]] placeholderImage:Image(@"chatListCellHead.png")];
    _nameLabel.text = [userDic objectForKey:kToNickName];
...
- (void)_setupSubviews
{
    ...
    _speakerOutLabel.font = sysFont(13);
