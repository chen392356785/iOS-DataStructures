...
- (UIView *)headerView
{
    if (_headerView == nil) {
        ...
        imageView.image = [UIImage imageNamed:@"Group_head.png"];
...
//        CGSize size = [_group.groupDescription sizeWithFont:sysFont(15) constrainedToSize:CGSizeMake(220, MAXFLOAT) lineBreakMode:NSLineBreakByCharWrapping];
		CGSize size = [_group.groupDescription boundingRectWithSize:CGSizeMake(220, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : sysFont(15.0f)} context:nil].size;
