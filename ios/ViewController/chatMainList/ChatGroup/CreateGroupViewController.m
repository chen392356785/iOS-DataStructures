...
- (void)viewDidLoad
{
    ...
    addButton.titleLabel.font = sysFont(14);
...
- (UIView *)switchView
{
    if (_switchView == nil) {
        ...
        _groupTypeLabel.font = sysFont(12);
        ...
        _groupMemberTitleLabel.font = sysFont(14);
        ...
        _groupMemberLabel.font = sysFont(12);
