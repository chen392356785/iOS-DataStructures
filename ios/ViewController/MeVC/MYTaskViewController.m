...
- (void)viewDidLoad {
    ...
    [network selectUserTaskInfoForId:[USERMODEL.userID intValue] success:^(NSDictionary *obj) {
        ...
        if ([infoDic[dic1[@"tag"]] intValue]>0 && [infoDic[dic2[@"tag"]] intValue]>0) {
        ...
        commTableView=[[UITableView alloc]initWithFrame:CGRectMake(0, 88, WindowWith, WindowHeight-88) style:UITableViewStyleGrouped];
