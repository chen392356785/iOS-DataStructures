...
-(void)RemoveImageCache
{
    ...
    NSString *text = [NSString stringWithFormat:@"占用：%.2f MB",(CGFloat)[[SDImageCache sharedImageCache] getSize] / (1024 * 1024)];
    ...
    if(indexPath.row==3){
            ...
            
        {
            ...
            str = [NSString stringWithFormat:
                   ...
                   @"itms-apps://ax.itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?type=Purple+Software&id=1178834496"];
