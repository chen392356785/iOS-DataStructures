...
@interface InvitedViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
-(void)loadRefesh:(MJRefreshComponent *)refreshView{
    ...
    [network getInvatedFriends:userID page:page num:10 success:^(NSDictionary *obj) {
        ...
        if (refreshView==commTableView.table.mj_header) {
            ...
            [commTableView.table.mj_footer resetNoMoreData];
        }
        ...
        if (arr.count>0) {
            ...
            if (dataArray.count == 0) {
                ...
                commTableView.table.tableFooterView = _imageView;
            }
            [self endRefresh];
            return;
        }
