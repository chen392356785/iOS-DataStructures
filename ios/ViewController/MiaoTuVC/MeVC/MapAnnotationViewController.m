...
-(void)submitClick:(UIButton *)sender{
    ...
    [myGeocoder geocodeAddressString:oreillyAddress completionHandler:^(NSArray *placemarks, NSError *error) {
        if ([placemarks count] > 0 && error == nil){
			...
			NSDictionary *dic=[ConfigManager getAddressInfoWithUser_id:0 country:nil province:nil city:nil area:nil street:nil longitude:0 latitude:0 company_lon:self->_longitude company_lat:self->_latitude distance:0 company_province:self->_province company_city:self->_city company_area:self->_town company_street:street];
