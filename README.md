####个人声明 ： 本代码纯属将源代码Java版本 重写为C++版本 适用于iOS开发者学习交流 视频课程请前往慕课网学习 
####请用Xcode9.0以上版本打开调试运行
...
| 2-1 使用Java中的数组 | [C++](02-Arrays/01-Array-Basics/src/) |
| 2-2 二次封装属于我们自己的数组 | [Java](02-Arrays/02-Create-Our-Own-Array/src/) |
| 2-3 向数组中添加元素 | [C++](02-Arrays/03-Add-Element-in-Array/src/) |
| 2-4 数组中查询元素和修改元素 | [Java](02-Arrays/04-Query-and-Update-Element/src/) |
| 2-5 包含，搜索和删除 | [C++](02-Arrays/05-Contain-Find-and-Remove/src/) |
| 2-6 使用泛型 | [C++](02-Arrays/06-Generic-Data-Structures/src/) |
| 2-7 动态数组 | [C++](02-Arrays/07-Dynamic-Array/src/) |
| 2-8 简单的复杂度分析 | [无代码] |
...
| 3-2 栈的基本实现 | [C++](03-Stacks-and-Queues/02-Array-Stack/src/) |
...
| 3-5 数组队列 | [C++](03-Stacks-and-Queues/05-Array-Queue/src/) |
| 3-6 循环队列 | [C++](03-Stacks-and-Queues/06-Loop-Queue/src/) |
| 3-7 循环队列的实现 | [C++](03-Stacks-and-Queues/07-Implementation-of-Loop-Queue/src/) |
| 3-8 数组队列和循环队列的比较 | [C++](03-Stacks-and-Queues/08-Queues-Comparison/src/) |
| 补充代码1: 没有size成员变量的循环队列 | [整理中，敬请期待] |
| **第四章 最基础的动态数据结构：链表** | [章节C++源码](04-Linked-List/) |
| 4-1 什么是链表 | [C++](04-Linked-List/01-Linked-List-Basics/src/) | 
| 4-2 在链表中添加元素 | [C++](04-Linked-List/02-Add-Elements-in-LinkedList/src/) | 
| 4-3 使用链表的虚拟头结点 | [C++](04-Linked-List/03-DummyHead-in-LinkedList/src/) | 
| 4-4 链表的遍历，查询和修改 | [C++](04-Linked-List/04-Query-and-Update-in-LinkedList/src/) | 
| 4-5 从链表中删除元素 | [C++](04-Linked-List/05-Remove-Element-in-LinkedList/src/) | 
| 4-6 使用链表实现栈 | [C++](04-Linked-List/06-Implement-Stack-in-LinkedList/src/) | 
| 4-7 带有尾指针的链表：使用链表实现队列 | [C++](04-Linked-List/07-Implement-Queue-in-LinkedList/src/) | 
| **第五章 透过链表看递归** | [章节C++源码](05-Recursion/) |
| 5-1 Leetcode中和链表相关的问题 | [C++](05-Recursion/01-Linked-List-Problems-in-Leetcode/src/) |
| 5-2 测试自己的Leetcode链表代码 | [C++](05-Recursion/02-Test-Your-LinkedList-Solution/src/) | 
| 5-3 递归基础与递归的宏观语意 | [C++](05-Recursion/03-Recursion-Basics/src/) | 
| 5-4 链表与递归 | [C++](05-Recursion/04-LinkedList-and-Recursion/src/) | 
| 5-5 递归运行的机制：递归的微观解读 | [无代码] | 
| 5-6 递归算法的调试 | [C++](05-Recursion/06-Debug-Recursive-Solution/src/) | 
| 5-7 更多和链表相关的问题 | [无代码] |
...
| 6-1 为什么要研究树结构 | [无代码] |
| 6-2 二分搜索树基础 | [C++](06-Binary-Search-Tree/02-Binary-Search-Tree-Basics/src/) |
| 6-3 向二分搜索树中添加元素 | [C++](06-Binary-Search-Tree/03-Add-Elements-in-BST/src/) |
| 6-4 改进添加操作：深入理解递归终止条件 | [Java](06-Binary-Search-Tree/04-Improved-Add-Elements-in-BST/src/) |
| 6-5 二分搜索树的查询操作 | [C++](06-Binary-Search-Tree/05-Search-in-BST/src/) |
| 6-6 二分搜索树的前序遍历 | [C++](06-Binary-Search-Tree/06-PreOrder-Traverse-in-BST/src/) |
| 6-7 二分搜索树的中序遍历和后序遍历 | [Java](06-Binary-Search-Tree/07-InOrder-and-PostOrder-Traverse-in-BST/src/) |
| 6-8 深入理解二分搜索树的前中后序遍历 | [无代码] |
| 6-9 二分搜索树前序遍历的非递归实现 | [C++](06-Binary-Search-Tree/09-Non-Recursion-Preorder-Traverse-in-BST/src/) |
| 6-10 二分搜索树的层序遍历 | [C++](06-Binary-Search-Tree/10-Level-Traverse-in-BST/src/) |
| 6-11 删除二分搜索树的最大元素和最小元素 | [Java](06-Binary-Search-Tree/11-Remove-Min-and-Max-in-BST/src/) |
| 6-12 删除二分搜索树的任意元素 | [C++](06-Binary-Search-Tree/12-Remove-Elements-in-BST/src/) |
...
| 7-2 基于链表的集合实现 | [C++](07-Set-and-Map/02-LinkedListSet/src/) |
| 7-3 集合类的复杂度分析 | [C++](07-Set-and-Map/03-Time-Complexity-of-Set/src/) |
| 7-4 Leetcode中的集合问题和更多集合相关问题 | [Java](07-Set-and-Map/04-TreeSet-and-Set-Problems-in-Leetcode/src/) |
| 7-5 映射基础 | [C++](07-Set-and-Map/05-Map-Basics/src/) |
| 7-6 基于链表的映射实现 | [C++](07-Set-and-Map/06-LinkedListMap/src/) |
| 7-7 基于二分搜索树的映射实现 | [C++](07-Set-and-Map/07-BSTMap/src/) |
| 7-8 映射的复杂度分析和更多映射相关问题 | [Java](07-Set-and-Map/08-More-about-Map/src/) |
| 7-9 Leetcode上更多集合和映射的问题 | [C++](07-Set-and-Map/09-Leetcode-Problems-about-Map-and-Set/src/) |
...
| 8-1 什么是优先队列 | [无代码] |
| 8-2 堆的基础表示 | [C++](08-Heap-and-Priority-Queue/02-Heap-Basics/src/) |
| 8-3 向堆中添加元素和Sift Up | [C++](08-Heap-and-Priority-Queue/03-Add-and-Sift-Up-in-Heap/src/) |
| 8-4 从堆中取出元素和Sift Down | [C++](08-Heap-and-Priority-Queue/04-Extract-and-Sift-Down-in-Heap/src/) |
| 8-5 Heapify 和 Replace | [C++](08-Heap-and-Priority-Queue/05-Heapify-and-Replace-in-Heap/src/) |
| 8-6 基于堆的优先队列 | [C++](08-Heap-and-Priority-Queue/06-Priority-Queue/src/) |
| 8-7 Leetcode上优先队列相关问题 | [C++](08-Heap-and-Priority-Queue/07-Priority-Queue-Problems-in-Leetcode/src/) |
| 8-8 Java中的PriorityQueue | [C++](08-Heap-and-Priority-Queue/08-Priority-Queue-in-Java/src/) |
...
| 9-1 什么是线段树 | [无代码] |
| 9-2 线段树基础表示 | [C++](09-Segment-Tree/02-Segment-Tree-Basics/src/) |
| 9-3 创建线段树 | [C++](09-Segment-Tree/03-Building-Segment-Tree/src/) |
| 9-4 线段树中的区间查询 | [C++](09-Segment-Tree/04-Query-in-Segment-Tree/src/) |
| 9-5 Leetcode上线段树相关的问题 | [Java](09-Segment-Tree/05-Segment-Tree-Problems-in-Leetcode/src/) |
| 9-6 线段树中的更新操作 | [C++](09-Segment-Tree/06-Update-Single-Element-in-Segment-Tree/src/) |
| 9-7 更多线段树相关的话题 | [无代码] |
...
| 10-1 什么是Trie字典树 | [无代码] |
| 10-2 Trie字典树基础 | [C++](10-Trie/02-Trie-Basics/src/) |
| 10-3 Trie字典树的查询 | [C++](10-Trie/03-Searching-in-Trie/src/) | 
| 10-4 Trie字典树的前缀查询 | [C++](10-Trie/04-Prefix-in-Trie/src/) |
| 10-5 Trie字典树和简单的模式匹配 | [C++](10-Trie/05-Trie-and-Pattern-Match/src/) |
| 10-6 Trie字典树和字符串映射 | [C++](10-Trie/06-Trie-and-Map/src/) |
| 10-7 更多和Trie字典树相关的话题 | [无代码] |
| 10-8 [文字补充] 基于哈希表或者数组的Trie | [C++](10-Trie/08-Trie-Using-HashMap-and-Array/src/) |
| 补充代码1: Trie的递归实现 | [C++](10-Trie/Optional-01-Trie-in-Recursion/src/) |
...
| 11-1 什么是并查集 | [C++](11-Union-Find/01-What-is-UnionFind/src/) |
| 11-2 Quick Find | [C++](11-Union-Find/02-Quick-Find/src/) |
| 11-3 Quick Union | [C++](11-Union-Find/03-Quick-Union/src/) |
| 11-4 基于size的优化 | [C++](11-Union-Find/04-Optimized-by-Size/src/) |
| 11-5 基于rank的优化 | [C++](11-Union-Find/05-Optimized-by-Rank/src/) |
| 11-6 路径压缩 | [Java](11-Union-Find/06-Path-Compression/src/) |
| 11-7 更多和并查集相关的话题 | [C++](11-Union-Find/07-More-about-Union-Find/src/) |
| **第十二章 平衡树和AVL** | [章节C++源码](12-AVL-Tree/) |
| 12-1 平衡树和AVL | [无代码] |
| 12-2 计算节点的高度和平衡因子 | [C++](12-AVL-Tree/02-Calculating-Balance-Factor/src/) |
| 12-3 检查二分搜索树性质和平衡性 | [C++](12-AVL-Tree/03-Checking-Balancing-and-Binary-Search-Property/src/) |
| 12-4 旋转操作的基本原理 | [C++](12-AVL-Tree/04-Rotation-Operations/src/) |
| 12-5 左旋转和右旋转的实现 | [C++](12-AVL-Tree/05-The-Implementation-of-Left-Rotation-and-Right-Rotation/src/) |
| 12-6 LR 和 RL | [C++](12-AVL-Tree/06-LR-and-RL/src/) |
| 12-7 从AVL树中删除元素 | [C++](12-AVL-Tree/07-Remove-Elements-in-AVL-Tree/src/) |
| 12-8 基于AVL树的集合和映射 | [C++](12-AVL-Tree/08-Map-and-Set-in-AVL-Tree/src/) |
| 补充代码1: AVL树的优化 | [整理中，敬请期待] |
| **第十三章 红黑树** | [章节C++源码](13-Red-Black-Tree/) |
| 13-1 红黑树与2-3树 | [无代码] |
| 13-2 2-3树的绝对平衡性 | [无代码] |
| 13-3 红黑树与2-3树的等价性 | [C++](13-Red-Black-Tree/03-The-Equivalence-of-RBTree-and-2-3-Tree/src/) |
| 13-4 红黑树的基本性质和复杂度分析 | [无代码] |
| 13-5 保持根节点为黑色和左旋转 | [C++](13-Red-Black-Tree/05-Keep-Root-Black-and-Left-Rotation/src/) |
| 13-6 颜色翻转和右旋转 | [C++](13-Red-Black-Tree/06-Flip-Colors-and-Right-Rotation/src/) |
| 13-7 红黑树中添加新元素 | [C++](13-Red-Black-Tree/07-Adding-Elements-in-Red-Black-Tree/src/) |
| 13-8 红黑树的性能测试 | [C++](13-Red-Black-Tree/08-The-Performance-of-Red-Black-Tree/src/) |
| 13-9 更多红黑树相关的话题 | [无代码] |
...
| 14-1 哈希表基础 | [C++](14-Hash-Table/01-Hash-Table-Basics/src/) |
| 14-2 哈希函数 | [无代码] |
| 14-3 Java中的hashCode方法 | [C++](14-Hash-Table/03-Hash-Function-in-Java/src/) |
| 14-4 链地址法 Seperate Chaining | [无代码] |
| 14-5 实现属于我们自己的哈希表 | [C++](14-Hash-Table/05-Hash-Table-Implementation/src/) |
| 14-6 哈希表的动态空间处理与复杂度分析 | [C++](14-Hash-Table/06-Resizing-in-Hash-Table/src/) |
| 14-7 哈希表更复杂的动态空间处理方法 | [C++](14-Hash-Table/07-More-About-Resizing-in-Hash-Table/src/) |
